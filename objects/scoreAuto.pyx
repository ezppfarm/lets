...
class score:
	...
	def calculatePP(self, b = None):
		...
		# Calculate pp
		if b.rankedStatus >= rankedStatuses.RANKED and b.rankedStatus != rankedStatuses.LOVED and b.rankedStatus != rankedStatuses.PENDING and b.rankedStatus != rankedStatuses.UNKNOWN \
